...
const GITHUB_PROJECTS = [
  ...
  },
  {
    ...
    theme: {
      ...
      badgeText: 'text-indigo-200 font-bold',
      badgeBorder: 'border-indigo-400/40',
      iconColor: '#818CF8',
      iconBg: 'bg-indigo-500/20',
      iconBorder: 'border-indigo-400/35',
      topLine: 'linear-gradient(90deg, #6366F1 0%, #818CF8 70%, transparent 100%)',
      topLineGlow: '0 0 14px rgba(99, 102, 241, 0.7)',
      cardBg:
        'linear-gradient(155deg, rgba(30, 27, 75, 0.45) 0%, rgba(15, 14, 38, 0.9) 55%, rgba(10, 10, 20, 0.98) 100%)',
      cardHoverBorder: 'hover:border-indigo-400/60 border-indigo-500/25',
      cardInnerGlow:
        'radial-gradient(ellipse 70% 50% at 50% 0%, rgba(99, 102, 241, 0.18) 0%, transparent 70%)',
      btnHover: 'hover:bg-indigo-500/25 hover:border-indigo-400/50 hover:text-indigo-100',
      skillBg: 'bg-indigo-950/40 text-indigo-100 border-indigo-500/25 hover:border-indigo-400/50',
    },
    description:
